  ...
  return (
    <div className="h-screen flex flex-col">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <ResizablePanelGroup direction="horizontal" className="flex-1 overflow-hidden bg-[#1e1e1e]">
          <ResizablePanel defaultSize={75} minSize={0} className="flex flex-col overflow-hidden">
            <TabBar />
            <ResizablePanelGroup direction="vertical" className="flex-1 min-h-0 bg-[#1e1e1e]">
              <ResizablePanel defaultSize={80} minSize={40} className="flex flex-col">
          ...
          <ResizablePanel defaultSize={20} minSize={0} className="h-full">
            <RightPanel />
          </ResizablePanel>
        </ResizablePanelGroup>
      </div>
